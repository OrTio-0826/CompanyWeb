    ...
    <div className="container max-w-7xl mx-auto px-4 py-32">
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-gray-600">
          혁신과 성장을 이끄는 OrTio Company의 리더쉽
        </p>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-12 mb-24 items-center">
        <div className="md:w-2/3">
          ...
          <div className="text-lg text-gray-600 space-y-6">
            <p>안녕하십니까, OrTio Company 대표이사 한규하입니다.</p>
            <p>
              저희 OrTio Company는 20년 이상의 전기 산업 경력을 바탕으로,
        ...
        <div className="md:w-1/3">
          <div className="rounded-xl overflow-hidden shadow-lg">
            ...
            <div className="p-4 bg-white">
              <h3 className="text-xl font-bold text-gray-800">한규하</h3>
